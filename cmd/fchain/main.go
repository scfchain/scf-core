...
const (
	clientIdentifier = "fchain" // Client identifier to advertise over the network
)
...
var (
	...
	app = flags.NewApp(gitCommit, gitDate, "the fchain command line interface")
