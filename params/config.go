...
type ChainConfig struct {
	...
	FenixValidatorContractAddress *common.Address `json:"fenixValidatorContractAddress,omitempty"` // Address of FChain Contract in the Fenix hardfork (nil = no blacklist)
