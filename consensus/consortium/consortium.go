...
type Consortium struct {
	...
	getFenixValidators func() ([]common.Address, error) // Get the validator list from FChain Validator contract of Fenix hardfork
}
...
// SetGetFenixValidators sets the function to get the validator list from FChain Validator contract of Fenix hardfork
